package br.senac.df.restapi.prova.controllers;
...
import br.senac.df.restapi.prova.repository.UsuarioRepository;
...
public class GreetingsController {
    ...
    public String  retornaOlaMundo(@PathVariable String nome) {
    	...
    	usuarioRepository.save(usuario);/*Grava no banco de dado*/
